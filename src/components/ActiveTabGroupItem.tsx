    ...
    <div>
      {editMode
        ...
        <ListItem>
          ...
          />
          <IconButton
            onClick={() => { runUpdateTabGroupName(props.id, tabGroupTitle) }}
          >
            <CheckIcon />
          </IconButton>
        ...
        <ListItem>
          <ListItemButton
            sx={{ pl: 4 }}
            onClick={() => { runUpdateTabGroupCollapsed(props.id, props.collapsed) }
            }
          >
